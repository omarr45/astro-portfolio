---
  ...
  featured: true
  draft: false
  description: A landing page for a fictional SaaS company, that provides a platform for businesses to manage their projects, collaborate, and automate their processes.
  image: '../../assets/techflow-home.webp'
  technologies: [
      'Open Source',
      'ReactJS',
      'TailwindCSS',
  ...
  links: {
    github: 'https://github.com/omarr45/TechFlow',
    live: 'https://techflow-pro.vercel.app/',
  }
---
...
<ImageSlider
  client:only="react"
  imgs={[
    "../../src/assets/techflow-home.webp",
    "../../src/assets/techflow-clients.webp",
    "../../src/assets/techflow-pricing.webp",
    "../../src/assets/techflow-home-light.webp",
    "../../src/assets/techflow-pricing-light.webp",
  ]}
/>
...
![Lighthouse score for TechFlow Pro](../../assets/techflow-a11y.png)
